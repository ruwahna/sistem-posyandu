    ...
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6 space-y-6">
      ...
      {activeTab === "Balita" && (
        <div className="bg-white rounded-xl border border-gray-200/80 p-5 shadow-2xs space-y-5">
          ...
          <div className="space-y-2">
            <h4 className="text-xs font-bold text-gray-500 uppercase tracking-wider">Status Gizi &amp; Perkembangan Utama</h4>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5">
              ...
              <div className="bg-white border border-gray-200/80 rounded-xl p-4 shadow-2xs hover:border-teal-300 transition-all flex flex-col justify-between">
                ...
                <div className="mt-2">
                  <div className="text-2xl font-extrabold text-gray-900 tracking-tight">{rekapanBalita.totalPemeriksaan}</div>
              ...
              <div className="bg-white border border-gray-200/80 rounded-xl p-4 shadow-2xs hover:border-emerald-300 transition-all flex flex-col justify-between">
                <div className="flex items-center justify-between gap-2">
                  <span className="text-[11px] font-bold text-gray-500 uppercase tracking-wider">Gizi Normal</span>
                ...
                <div className="mt-2">
                  <div className="text-2xl font-extrabold text-gray-900 tracking-tight">{rekapanBalita.statusBbTb.normal}</div>
              ...
              <div className="bg-white border border-gray-200/80 rounded-xl p-4 shadow-2xs hover:border-amber-300 transition-all flex flex-col justify-between">
                <div className="flex items-center justify-between gap-2">
                  <span className="text-[11px] font-bold text-gray-500 uppercase tracking-wider">Gizi Kurang</span>
                ...
                <div className="mt-2">
                  <div className="text-2xl font-extrabold text-gray-900 tracking-tight">{rekapanBalita.statusBbTb.kurang}</div>
              ...
              <div className="bg-white border border-gray-200/80 rounded-xl p-4 shadow-2xs hover:border-red-300 transition-all flex flex-col justify-between">
                <div className="flex items-center justify-between gap-2">
                  <span className="text-[11px] font-bold text-gray-500 uppercase tracking-wider">Gizi Buruk</span>
                ...
                <div className="mt-2">
                  <div className="text-2xl font-extrabold text-gray-900 tracking-tight">{rekapanBalita.statusBbTb.sangatKurang}</div>
          ...
          <div className="space-y-2 pt-2 border-t border-gray-100">
            <h4 className="text-xs font-bold text-gray-500 uppercase tracking-wider">Indikator Berat Badan, Suplementasi &amp; Stunting</h4>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3">
              ...
              <div className="bg-white border border-gray-200/80 rounded-xl p-3.5 shadow-2xs hover:border-gray-300 transition-all flex flex-col justify-between">
                <div className="flex items-center justify-between gap-1.5">
                  <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider">BB/U Normal</span>
                  <div className="w-6 h-6 rounded bg-emerald-50 text-emerald-600 flex items-center justify-center shrink-0">
                    <CheckCircle2 className="w-3.5 h-3.5" />
                  </div>
                </div>
                <div className="mt-1.5">
                  <div className="text-xl font-extrabold text-gray-900">{rekapanBalita.statusBbU.normal}</div>
              ...
              <div className="bg-white border border-gray-200/80 rounded-xl p-3.5 shadow-2xs hover:border-gray-300 transition-all flex flex-col justify-between">
                <div className="flex items-center justify-between gap-1.5">
                  <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider">BB/U Kurang</span>
                  <div className="w-6 h-6 rounded bg-amber-50 text-amber-600 flex items-center justify-center shrink-0">
                    <AlertTriangle className="w-3.5 h-3.5" />
                  </div>
                </div>
                <div className="mt-1.5">
                  <div className="text-xl font-extrabold text-gray-900">{rekapanBalita.statusBbU.kurang}</div>
              ...
              <div className="bg-white border border-gray-200/80 rounded-xl p-3.5 shadow-2xs hover:border-gray-300 transition-all flex flex-col justify-between">
                <div className="flex items-center justify-between gap-1.5">
                  <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider">BB/U S.Kurang</span>
                  <div className="w-6 h-6 rounded bg-red-50 text-red-600 flex items-center justify-center shrink-0">
                    <Activity className="w-3.5 h-3.5" />
                  </div>
                </div>
                <div className="mt-1.5">
                  <div className="text-xl font-extrabold text-gray-900">{rekapanBalita.statusBbU.sangatKurang}</div>
              ...
              <div className="bg-white border border-gray-200/80 rounded-xl p-3.5 shadow-2xs hover:border-gray-300 transition-all flex flex-col justify-between">
                <div className="flex items-center justify-between gap-1.5">
                  <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider">Imun. Lengkap</span>
                  <div className="w-6 h-6 rounded bg-indigo-50 text-indigo-600 flex items-center justify-center shrink-0">
                    <ShieldCheck className="w-3.5 h-3.5" />
                  </div>
                </div>
                <div className="mt-1.5">
                  <div className="text-xl font-extrabold text-gray-900">{rekapanBalita.imunisasiLengkap}</div>
              ...
              <div className="bg-white border border-gray-200/80 rounded-xl p-3.5 shadow-2xs hover:border-gray-300 transition-all flex flex-col justify-between">
                <div className="flex items-center justify-between gap-1.5">
                  <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider">Vitamin A</span>
                ...
                <div className="mt-1.5">
                  <div className="text-xl font-extrabold text-gray-900">{rekapanBalita.vitaminA}</div>
              ...
              <div className="bg-white border border-gray-200/80 rounded-xl p-3.5 shadow-2xs hover:border-gray-300 transition-all flex flex-col justify-between">
                <div className="flex items-center justify-between gap-1.5">
                  <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider">Stunting (TB/U)</span>
                  <div className="w-6 h-6 rounded bg-purple-50 text-purple-600 flex items-center justify-center shrink-0">
                    <BalitaIcon className="w-3.5 h-3.5 text-purple-600" />
                  </div>
                </div>
                <div className="mt-1.5">
      ...
      {activeTab === "Lansia" && (
        <div className="bg-white rounded-xl border border-gray-200/80 p-5 shadow-2xs space-y-5">
          ...
          <div className="space-y-2 pt-2 border-t border-gray-100">
            <h4 className="text-xs font-bold text-gray-500 uppercase tracking-wider">Indikator IMT, Gula Darah &amp; Kolesterol</h4>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3">
              {/* IMT Normal */}
              <div className="bg-white border border-gray-200/80 rounded-xl p-3.5 shadow-2xs hover:border-gray-300 transition-all flex flex-col justify-between">
                <div className="flex items-center justify-between gap-1.5">
              ...
              <div className="bg-white border border-gray-200/80 rounded-xl p-3.5 shadow-2xs hover:border-gray-300 transition-all flex flex-col justify-between">
                <div className="flex items-center justify-between gap-1.5">
                  <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider">IMT Kurang</span>
                  <div className="w-6 h-6 rounded bg-amber-50 text-amber-600 flex items-center justify-center shrink-0">
                    <Scale className="w-3.5 h-3.5" />
                  </div>
                </div>
              ...
              <div className="bg-white border border-gray-200/80 rounded-xl p-3.5 shadow-2xs hover:border-gray-300 transition-all flex flex-col justify-between">
                <div className="flex items-center justify-between gap-1.5">
                  <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider">IMT Berlebih</span>
